...
// Consolida em abas os itens que eram entradas próprias na barra de
...
// benchmarking, /simulacao-carteira, /treino-custom, /modelo-v9,
// /carteira-paper-trading) continuam existindo, sem uso ativo pela
// navegação principal.
import React from 'react';
import { Zap, Wallet, FlaskConical, Layers, Landmark } from 'lucide-react';
import Tabs from '../components/Tabs';
import ModelBenchmarking from './ModelBenchmarking';
import SimulacaoCarteira from './SimulacaoCarteira';
import CarteiraPaperTrading from './CarteiraPaperTrading';
